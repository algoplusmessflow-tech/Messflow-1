// INTEGRATION GUIDE FOR SUPERADMIN.TSX
// Add this import at the top of your SuperAdmin.tsx file (around line 29, after other imports)

import { TenantManagementTab, TenantWithModes } from '@/components/TenantManagementTab';

// ============================================================
// THEN: Find the "Tenants" tab in the TabsContent section and REPLACE it with:
// ============================================================
...
<TabsContent value="tenants" className="mt-4">
  <TenantManagementTab
    tenants={allProfiles.map(profile => ({
      ...
      active_modes: profile.active_modes || [], // Assuming this exists in your profile
    })) as TenantWithModes[]}
    ...
    onActivateMode={async (tenantId, mode) => {
      try {
        // Call your Supabase RPC or API endpoint to activate the mode
        // Example: await supabase.rpc('mode_activation.activate_mode', { p_tenant_id: tenantId, p_mode: mode })
        toast.success(`${mode} mode activated for this business`);
        // Refetch tenants data
      } catch (error: any) {
...
// ============================================================
// THEN: REMOVE or COMMENT OUT the old Tenants tab content that looked like:
// ============================================================
/*
<TabsContent value="tenants" className="mt-4">
  <Card className="...">
...
// ============================================================
// ALSO: Make sure the Mode Activation tab now shows this content:
// ============================================================
