  ...
  public: {
    Tables: {
      ...
      delivery_batches: {
        ...
        Relationships: [
          {
            foreignKeyName: "delivery_batches_area_id_fkey"
            columns: ["area_id"]
            isOneToOne: false
      ...
      batch_deliveries: {
        ...
        Relationships: [
          {
            foreignKeyName: "batch_deliveries_batch_id_fkey"
            columns: ["batch_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "batch_deliveries_member_id_fkey"
            columns: ["member_id"]
            isOneToOne: false
      ...
      delivery_status_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "delivery_status_logs_batch_delivery_id_fkey"
            columns: ["batch_delivery_id"]
            isOneToOne: false
            referencedRelation: "batch_deliveries"
            referencedColumns: ["id"]
          },
        ]
      }
