-- ============================================================================
-- MESSFLOW MODE-ISOLATED SCHEMA - RESTAURANT + MESS + CANTEEN
-- PostgreSQL / Supabase
-- Complete separation of concerns per business mode
-- ============================================================================
...
-- ============================================================================
-- SCHEMA: RESTAURANTS (Restaurant Mode - Standalone)
-- ============================================================================
...
-- ============================================================================
-- RESTAURANT-SPECIFIC: Menu Items (Video-Style Management)
-- ============================================================================
...
-- ============================================================================
-- RESTAURANT-SPECIFIC: Kitchen Orders (Standalone)
-- ============================================================================
...
CREATE INDEX idx_restaurant_menu_category ON restaurants.menu_items(venue_id, category);
CREATE INDEX idx_restaurant_kitchen_orders_venue ON restaurants.kitchen_orders(venue_id);
CREATE INDEX idx_restaurant_kitchen_orders_status ON restaurants.kitchen_orders(venue_id, status);
CREATE INDEX idx_restaurant_kitchen_orders_created ON restaurants.kitchen_orders(created_at);
CREATE INDEX idx_restaurant_reservations_venue ON restaurants.reservations(venue_id);
CREATE INDEX idx_restaurant_reservations_time ON restaurants.reservations(reservation_time);
CREATE INDEX idx_restaurant_tables_venue ON restaurants.tables(venue_id);
CREATE INDEX idx_locks_expires ON restaurants.table_locks(expires_at);

-- ============================================================================
-- RLS POLICIES: RESTAURANT MODE (Multi-tenant Isolation)
-- ============================================================================
...
ALTER TABLE restaurants.reservations ENABLE ROW LEVEL SECURITY;
...
BEGIN
  ...
  SELECT 
    ...
    ko.priority,
    ko.created_at,
    EXTRACT(MINUTE FROM (NOW() - ko.created_at))::INTEGER
...
GRANT INSERT, UPDATE, DELETE ON restaurants.reservations TO authenticated;
